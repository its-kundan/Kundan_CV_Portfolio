...
export default function SparklesPreview() {
  return (
    (<div
      ...
      className="bg-white p-5 dark:bg-slate-900 text-black dark:text-white border border-neutral-200 dark:border-slate-800"
      onClick={navigateToGoogle} // Set the onClick handler
    >
      Under Development
    </button>
    </div>)
