...
const Navbar = () => {
  ...
  const menuButtonRef = useRef(null); // Reference to the menu button (Bars3Icon)

  // Close the menu if the user clicks outside the navbar or menu
  useEffect(() => {
    const handleClickOutside = (event) => {
      // Check if the click is outside both the navbar and menu
      if (
        navbarRef.current && 
  ...
  return (
    <nav
      ref={navbarRef} // Add reference to the entire navbar
    ...
    >
      <div className="flex container lg:py-4 flex-wrap items-center justify-between mx-auto px-4 py-2">
        ...
        <div className="mobile-menu block md:hidden">
          {!navbarOpen ? (
            <button
              ref={menuButtonRef} // Reference to the menu button
