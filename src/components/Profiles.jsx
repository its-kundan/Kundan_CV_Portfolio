...
import imageData from './../../public/data'; // Adjust this import path according to your project structure
    ...
    <div className="w-full max-w-screen-lg mx-auto overflow-hidden relative">
      ...
      <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 space-x-2">
        {images.map((_, idx) => (
          <button
            key={idx}
            className={`h-3 w-3 rounded-full ${currentIndex === idx ? 'bg-blue-600' : 'bg-white'}`}
